...
function createSVG(SVGtext, SVGtextColor, SVGshape, SVGshapeColor) {
    const shape = (SVGshape) => {
        if (SVGshape == 'circle') {
            return new Circle(SVGtext, SVGtextColor, SVGshapeColor).render()
        }
        if (SVGshape == 'Square') {
            return new Square(SVGtext, SVGtextColor, SVGshapeColor).render()
        }
        if (SVGshape == 'triangle') {
            return new Triangle(SVGtext, SVGtextColor, SVGshapeColor).render()
        }
        else {
